...
internal static class Cfw2Strings
{
    ...
    public static string Read(BufferReader reader)
    {
        ...
        {
            throw new InvalidDataException(string.Format(Strings.CFW2StringLengthOutOfRange0, length));
        }
    ...
    public static void Write(BufferWriter writer, string value)
    {
        ...
        {
            throw new InvalidDataException(Strings.CFW2StringContainsCharactersThatCannotEncoded);
        }
