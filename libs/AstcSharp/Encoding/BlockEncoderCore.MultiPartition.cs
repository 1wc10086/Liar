...
internal static partial class BlockEncoderCore
{
        ...
        where TStrategy : struct, IColorSpaceStrategy<TTexel>
    {
        ...
        if (SearchConfigs<TTexel, TStrategy>(in block, candidateModes, MultiColorStartBit, strategy.EarlyOutPerSampleError * texelCount * ChannelCount, in scratch) is not { } result)
        {
            return default;
        }
